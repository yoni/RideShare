...
*-----------------------------------------------------------------------------
*****************************************************************************/
#ifndef _MQGEOCODEOPTIONSCOLLECTION_H_
// {secret}
#define _MQGEOCODEOPTIONSCOLLECTION_H_
...
/**
 * used to hold user defined geocode options.
 * @see CMQGeocodeOptions
 * @see CMQObjectCollection
 * @ingroup Mapquest
 */
class CMQGeocodeOptionsCollection : public CMQObjectCollection<CMQGeocodeOptions *>
{
public:
   /**
    * Constructor
    */
   CMQGeocodeOptionsCollection();
   ...
   enum              {CLASS_ID = 1200};
#else
   static const int   CLASS_ID = 1200;
#endif
   /**
...
#endif   // _MQGEOCODEOPTIONSCOLLECTION_H_
