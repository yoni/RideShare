...
*-----------------------------------------------------------------------------
*****************************************************************************/
#ifndef _MQCOVERAGESTYLE_H_
// {secret}
#define _MQCOVERAGESTYLE_H_
...
/**
 * holds user defined DTSTyles for user features
 * @see CMQDTStyle
 * @see CMQDTStyleEx
 ...
 * @ingroup Mapquest
 */
class CMQCoverageStyle : public CMQObjectCollection<CMQBaseDTStyle *>
{
public:
   /**
    * Constructor
   ...
   /**
    * Set the name of the coverage style.
    * @param szName    The name of this coverage style
    */
   void              SetName(const char* szName);
   /**
    * Get the name of the coverage style.
    * @return    The name of this coverage style
    */
   ...
   enum              {CLASS_ID = 1050};
#else
   static const int   CLASS_ID = 1050;
#endif
   /**
