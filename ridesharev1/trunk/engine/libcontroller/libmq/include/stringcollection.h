...
*-----------------------------------------------------------------------------
*****************************************************************************/
#ifndef _MQSTRINGCOLLECTION_H_
// {secret}
#define _MQSTRINGCOLLECTION_H_
...
/**
 * Collection to hold CMQString objects
 * @see CMQObjectCollection
 * @ingroup Mapquest
 */
class CMQStringCollection : public CMQSimpleCollection<CMQString>
{
public:
   /**
    * Constructor
   ...
   enum              {CLASS_ID = 1542};
#else
   static const int   CLASS_ID = 1542;
#endif
   /**
