...
*-----------------------------------------------------------------------------
*****************************************************************************/
#ifndef _MQDTCOLLECTION_H_
// {secret}
#define _MQDTCOLLECTION_H_

#include "mqobject.h"
#include "objectcollection.h"

/**
 * Collection to hold Display Type values
 * @see CMQObjectCollection
 * @ingroup Mapquest
 */
class CMQDTCollection : public CMQSimpleCollection<int>
{
public:
   /**
    * Constructor
   ...
   enum              {CLASS_ID = 1040};
#else
   static const int   CLASS_ID = 1040;
#endif
   /**
   ...
   /**
    * Is DT contained in this collection?
    * @param nDT the DT to check
    * @return   true or false;
    */
   bool Contains(int nDT) const;
